...
<html>
  <head>    
    <title>Stromverbrauch - Aktuelle Z&aumlhlerdaten</title>         
    <meta name="keywords" content="Stromverbrauch - Z&aumlhlerdaten" />    
    <meta name="description" content="Stromverbrauch - Z&aumlhlerdaten" />    
    <meta name="googlebot" content="NOODP">    
  </head>
  <body>
  <h1>Stromverbrauch - Aktuelle Z&aumlhlerdaten</h1>  
...
<table border>
    ...
    <tr>
      <td>Verbrauch - Heute (kw/h)</td>
      <td ALIGN="CENTER"> <?php print($gesamt_today) ?></td>
    </tr>
    <tr>
      <td>Verbrauch - Diese Woche (kw/h)</td>
      <td ALIGN="CENTER"> <?php print($gesamt_week) ?></td>
    </tr>
    <tr>
      <td>Verbrauch - Dieser Monat (kw/h)</td>
      <td ALIGN="CENTER"> <?php print($gesamt_month) ?></td>
    </tr>
    <tr>
      <td>Verbrauch - Dieses Jahr (kw/h)</td>
...
///////////////////////////////////////////////////     
        var meter = new RGraph.Meter({
            ...
            options: {
                title:  'Leistung <?php print($leistung) ?> Watt',
                titleSize: 10,
                textSize: 8,
                gutterTop: 30, 
                unitsPost: '',
