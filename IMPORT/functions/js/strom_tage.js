...
/*      $( "#datepicker" ).datepicker(); */
      $( "#startzeitpunkt" ).datetimepicker( { dateFormat: 'yy-mm-dd',  timeFormat: 'HH:mm:ss' } ); 
      $( "#endezeitpunkt" ).datetimepicker( { dateFormat: 'yy-mm-dd', timeFormat: 'HH:mm:ss' } ); 
...
function datum_init()
    {
        var f_now  = new Date();
        var f_date = "";
        f_date += f_now.getFullYear() + '-';
        f_date += f_now.getMonth() + 1  + "-";
        f_date += f_now.getDate() + " 00:00:00";        
        self.document.form1.endezeitpunkt.value = f_date;

        var f_date = "";
        f_date += f_now.getFullYear() + '-';
        f_date += f_now.getMonth() + 1  + "-";
        f_date += "01" + " 00:00:00";        
        self.document.form1.startzeitpunkt.value = f_date;
    }  
//
...
function get_data3(starti, ende){
    ...
    var aj = $.ajax({
        type: "POST",
        url: "/functions/php/get_tage.php",
        data: postdata,
        dataType: 'json',
        cache: false,
        async: false
...
//
  function chkForm(formu)
  {
    ...
    if (start == "" || ende == "")
    {
        alert("Bitte Start- und Endetag eingeben!");
...
//      var rdata = get_data_jquery (formu.startzeitpunkt.value, formu.endezeitpunkt.value);
      var rdata = get_data3(start, ende);
//      alert(rdata);
...
function processing(formu) {
  ...
  { 
   ...
   var durchschnitt = "Durchschnittswert:" + " " + daten[0] + " " + "kw/h pro Tag"; 
