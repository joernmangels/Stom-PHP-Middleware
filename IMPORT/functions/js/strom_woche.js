...
//  $( "#startzeitpunkt" ).datetimepicker( { dateFormat: 'yy-mm-dd', timeFormat: 'HH:mm:ss' } ); 
    ...
    , dateFormat: 'yy-mm-dd'+' 23:59:59', numberOfMonths: 3});
...
function get_data3(starti, ende){
    ...
    var aj = $.ajax({
        type: "POST",
        url: "/functions/php/get_woche.php",
        data: postdata,
        dataType: 'json',
        cache: false,
        async: false
...
//
  function chkForm(formu)
  {
    ...
    if (start == "" || ende == "")
    {
        alert("Bitte Start- und Endewoche eingeben!");
...
function processing(formu) {
  ...
  { 
   ...
   var durchschnitt = "Durchschnittswert:" + " " + daten[0] + " " + "kw/h pro Woche"; 
